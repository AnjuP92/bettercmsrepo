        ...
        function initializeTemplatesList(isSearchResult) {
            if (typeof ids != 'undefined') {
                $.each(ids.split(','), function (index, value) {
                    $('tr[data-id=' + value + '] div.bcms-grid-item-edit-button,tr[data-id=' + value + '] .bcms-grid-item-delete-button').hide();
                    $('tr[data-id=' + value + '] a.bcms-grid-item-edit-button').removeAttr('data-id');
                });
            }
