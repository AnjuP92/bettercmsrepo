    ...
    internal class DefaultMediaFileService : IMediaFileService
    {
        ...
        public virtual void RemoveFile(Guid fileId, int version, bool doNotCheckVersion = false)
        {
            ...
            finally
            {
                ...
                saveitem.Add("Id", file.Id);
                string js = JsonConvert.SerializeObject(saveitem);
                var model = _webClient.DownloadData<int>("MediaManager/MediaDeleteFile", new { JS = js });
                                        ...
                                        while (true)
                                        {
                                            ...
                                            if (!MoveToTrash(session, fileToMove, serverUrl))
                                            {
                                                try
                                                {
                                                    ...
                                                    JObject saveitem = new JObject();
                                                    saveitem.Add("Id", fileToMove.Id);
                                                    saveitem.Add("IsMovedToTrash", fileToMove.IsMovedToTrash);
                                                    string js = JsonConvert.SerializeObject(saveitem);
                                                    var model = _webClient.DownloadData<int>("MediaManager/SaveMediaMoveToTrash", new { JS = js });
            ...
            string title = "", string description = "")
        {
            ...
            savemediaitem.Add("Id", file.Id);
            savemediaitem.Add("Version", file.Version);
            savemediaitem.Add("IsDeleted", file.IsDeleted);
            savemediaitem.Add("Title", file.Title);
            savemediaitem.Add("Type", file.Type.ToString());
            savemediaitem.Add("ContentType", file.ContentType.ToString());
            savemediaitem.Add("IsArchived", file.IsArchived);
            savemediaitem.Add("Description", file.Description);
            savemediaitem.Add("OriginalFileName", file.OriginalFileName);
            savemediaitem.Add("OriginalFileExtension", file.OriginalFileExtension);
            savemediaitem.Add("FileUri", file.FileUri);
            savemediaitem.Add("PublicUrl", file.PublicUrl);
            savemediaitem.Add("Size", file.Size);
            savemediaitem.Add("IsTemporary", file.IsTemporary);
            savemediaitem.Add("IsUploaded", file.IsUploaded);
            savemediaitem.Add("IsCanceled", file.IsCanceled);
            savemediaitem.Add("IsMovedToTrash", file.IsMovedToTrash);
            savemediaitem.Add("NextTryToMoveToTrash ", file.NextTryToMoveToTrash);

            string js = JsonConvert.SerializeObject(savemediaitem);
            var model = _webClient.DownloadData<string>("MediaManager/SaveMediaFile", new { JS = js });

            file.Id = new Guid(model);
            ...
            Guid? reuploadMediaId = null)
        {
            ...
            JObject savemediaitem = new JObject();
            savemediaitem.Add("Id", tempFile.Id);
            savemediaitem.Add("Version", tempFile.Version);
            savemediaitem.Add("IsDeleted", tempFile.IsDeleted);
            savemediaitem.Add("Title", tempFile.Title);
            savemediaitem.Add("Type", tempFile.Type.ToString());
            savemediaitem.Add("ContentType", tempFile.ContentType.ToString());
            savemediaitem.Add("IsArchived", tempFile.IsArchived);
            savemediaitem.Add("Description", tempFile.Description);
            savemediaitem.Add("OriginalFileName", tempFile.OriginalFileName);
            savemediaitem.Add("OriginalFileExtension", tempFile.OriginalFileExtension);
            savemediaitem.Add("FileUri", tempFile.FileUri);
            savemediaitem.Add("PublicUrl", tempFile.PublicUrl);
            savemediaitem.Add("Size", tempFile.Size);
            savemediaitem.Add("IsTemporary", tempFile.IsTemporary);
            savemediaitem.Add("IsUploaded", tempFile.IsUploaded);
            savemediaitem.Add("IsCanceled", tempFile.IsCanceled);
            savemediaitem.Add("IsMovedToTrash", tempFile.IsMovedToTrash);
            savemediaitem.Add("NextTryToMoveToTrash ", tempFile.NextTryToMoveToTrash);

            string js = JsonConvert.SerializeObject(savemediaitem);
            var model = _webClient.DownloadData<string>("MediaManager/SaveMediaFile", new { JS = js });
            tempFile.Id = new Guid(model);
            ...
            if (waitForUploadResult)
            {
                ...
                var model1 = _webClient.DownloadData<string>("MediaManager/SaveMediaFile", new { JS = js });
                tempFile.Id = new Guid(model1);
        ...
        private void SaveOriginalMediaFile(Guid originalId, MediaFile mediaFile, ISession session)
        {
            ...
            JObject savemediaitem = new JObject();
            savemediaitem.Add("Id", originalEntity.Id);
            savemediaitem.Add("Version", originalEntity.Version);
            savemediaitem.Add("IsDeleted", originalEntity.IsDeleted);
            savemediaitem.Add("Title", originalEntity.Title);
            savemediaitem.Add("Type", originalEntity.Type.ToString());
            savemediaitem.Add("ContentType", originalEntity.ContentType.ToString());
            savemediaitem.Add("IsArchived", originalEntity.IsArchived);
            savemediaitem.Add("Description", originalEntity.Description);
            savemediaitem.Add("OriginalFileName", originalEntity.OriginalFileName);
            savemediaitem.Add("OriginalFileExtension", originalEntity.OriginalFileExtension);
            savemediaitem.Add("FileUri", originalEntity.FileUri);
            savemediaitem.Add("PublicUrl", originalEntity.PublicUrl);
            savemediaitem.Add("Size", originalEntity.Size);
            savemediaitem.Add("IsTemporary", originalEntity.IsTemporary);
            savemediaitem.Add("IsUploaded", originalEntity.IsUploaded);
            savemediaitem.Add("IsCanceled", originalEntity.IsCanceled);
            savemediaitem.Add("IsMovedToTrash", originalEntity.IsMovedToTrash);
            savemediaitem.Add("NextTryToMoveToTrash ", originalEntity.NextTryToMoveToTrash);

            string js = JsonConvert.SerializeObject(savemediaitem);
            var model = _webClient.DownloadData<int>("MediaManager/UpdateMediaFile", new { JS = js });
            ...
            where TMedia : MediaFile
        {
            ...
            Action<ISession> failedResultAction = session =>
            {
                ...
                if (media != null)
                {
                    ...
                    JObject savemediaitem = new JObject();
                    savemediaitem.Add("Id", media.Id);
                    savemediaitem.Add("Version", media.Version);
                    savemediaitem.Add("IsDeleted", media.IsDeleted);
                    savemediaitem.Add("Title", media.Title);
                    savemediaitem.Add("Type", media.Type.ToString());
                    savemediaitem.Add("ContentType", media.ContentType.ToString());
                    savemediaitem.Add("IsArchived", media.IsArchived);
                    savemediaitem.Add("Description", media.Description);
                    savemediaitem.Add("OriginalFileName", media.OriginalFileName);
                    savemediaitem.Add("OriginalFileExtension", media.OriginalFileExtension);
                    savemediaitem.Add("FileUri", media.FileUri);
                    savemediaitem.Add("PublicUrl", media.PublicUrl);
                    savemediaitem.Add("Size", media.Size);
                    savemediaitem.Add("IsTemporary", media.IsTemporary);
                    savemediaitem.Add("IsUploaded", media.IsUploaded);
                    savemediaitem.Add("IsCanceled", media.IsCanceled);
                    savemediaitem.Add("IsMovedToTrash", media.IsMovedToTrash);
                    savemediaitem.Add("NextTryToMoveToTrash ", media.NextTryToMoveToTrash);
        ...
        public void SaveMediaFile(MediaFile file)
        {
            ...
            string js = JsonConvert.SerializeObject(savemediaitem);
            var model = _webClient.DownloadData<int>("MediaManager/SaveMediaFile", new { JS = js });
