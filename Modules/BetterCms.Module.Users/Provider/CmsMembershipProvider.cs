...
// ReSharper restore UnusedMember.Global
        ...
        public  bool ValidateSocialUser(string username)
        {
            if (authenticationService == null)
            {
                using (var container = ContextScopeProvider.CreateChildContainer())
                {
                    return ValidateSocialUser(container.Resolve<IAuthenticationService>(), username);
                }
            }

            return ValidateSocialUser(authenticationService, username);
        }
        ...
        private static bool ValidateSocialUser(IAuthenticationService authenticationService, string username)
        {
            return authenticationService.ValidateSocialUser(username);
        }
