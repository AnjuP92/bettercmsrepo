...
namespace BetterCms.Module.Users.Services
{
    public class DefaultAuthenticationService : IAuthenticationService
    {
        ...
        ///   <c>true</c>, if username and password are equal.
        /// </returns>
        public bool ValidateSocialUser(string username)
        {
            var userId = GetSocialUserIdIfValid(username);
            return userId.HasValue && userId.Value != Guid.Empty;
        }
        ...
        {
            //var id = string.Empty;
            //var encrypted_password = string.Empty;
            //var salt = string.Empty;
            if (string.IsNullOrWhiteSpace(username) || string.IsNullOrWhiteSpace(password))
            {
                return null;
            }
            //JObject response = _webClient.DownloadData<JObject>("User/ApiGetUserIdIfvalid", new { UserName = username });

            //var user = new { Id = response.GetValue("Id").Value<string>(), Password = response.GetValue("Password").Value<string>(), Salt = response.GetValue("Salt").Value<string>() };
            ...
            //if (response != null)
            //{
            //    Guid newid = Guid.Parse((string)response.SelectToken("Id"));
            //    if (CheckPassword(password, (string)response.SelectToken("Password"), (string)response.SelectToken("Salt")))
            //    {
            //        return newid;
            //    }
            //}
            ...
            //if (id != null && encrypted_password != null && salt != null)
            //{
            //    Guid newGuid = Guid.Parse(id);
            //    if (CheckPassword(password, encrypted_password, salt))
            //    {
            //        return newGuid;
            //    }
            //}
        ...
        /// <summary>
        /// Gets the social user identifier if valid.
        /// </summary>
        /// <param name="username">The username.</param>
        /// <returns>
        /// User Id if user is valid.
        /// </returns>
        public Guid? GetSocialUserIdIfValid(string username)
        {
            //var id = string.Empty;
            //var encrypted_password = string.Empty;
            //var salt = string.Empty;
